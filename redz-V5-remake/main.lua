...
ColorSequenceKeypoint.new(0.00,Color3.fromRGB(18,5,25)),
ColorSequenceKeypoint.new(0.50,Color3.fromRGB(28,10,40)),
ColorSequenceKeypoint.new(1.00,Color3.fromRGB(18,5,25))
},
Primary=Color3.fromRGB(160,80,255),
OnPrimary=Color3.fromRGB(90,30,160),
ScrollBar=Color3.fromRGB(120,50,200),
Stroke=Color3.fromRGB(45,15,60),
Error=Color3.fromRGB(255,80,120),
Icons=Color3.fromRGB(240,230,255),
JoinButton=Color3.fromRGB(130,40,210),
Link=Color3.fromRGB(210,140,255),
Dialog={Background=Color3.fromRGB(22,8,30)},
Buttons={
Holding=Color3.fromRGB(180,100,255),
Default=Color3.fromRGB(40,15,55)
},
Border={
Holding=Color3.fromRGB(200,130,255),
Default=Color3.fromRGB(60,25,85),
},
Text={
Default=Color3.fromRGB(255,255,255),
Dark=Color3.fromRGB(210,190,230),
Darker=Color3.fromRGB(180,160,200),
},
Slider={
SliderBar=Color3.fromRGB(120,50,200),
SliderNumber=Color3.fromRGB(245,240,255),
},
Dropdown={Holder=Color3.fromRGB(30,10,45)}
},
Icons={
...
Font={Normal=Enum.Font.BuilderSans,Medium=Enum.Font.BuilderSansMedium,Bold=Enum.Font.BuilderSansBold,ExtraBold=Enum.Font.BuilderSansExtraBold,SliderValue=Enum.Font.FredokaOne},
BackgroundTransparency=0.03
},
Red={
Colors={
Background=ColorSequence.new{
ColorSequenceKeypoint.new(0.00,Color3.fromRGB(25,5,5)),
ColorSequenceKeypoint.new(0.50,Color3.fromRGB(35,10,10)),
ColorSequenceKeypoint.new(1.00,Color3.fromRGB(25,5,5))
},
Primary=Color3.fromRGB(255,65,65),
OnPrimary=Color3.fromRGB(150,30,30),
ScrollBar=Color3.fromRGB(180,40,40),
Stroke=Color3.fromRGB(60,15,15),
Error=Color3.fromRGB(255,110,110),
Icons=Color3.fromRGB(255,235,235),
JoinButton=Color3.fromRGB(190,35,35),
Link=Color3.fromRGB(255,120,120),
Dialog={Background=Color3.fromRGB(30,10,10)},
Buttons={
Holding=Color3.fromRGB(230,50,50),
Default=Color3.fromRGB(50,15,15)
},
Border={
Holding=Color3.fromRGB(255,80,80),
Default=Color3.fromRGB(80,25,25),
},
Text={
Default=Color3.fromRGB(255,255,255),
Dark=Color3.fromRGB(230,190,190),
Darker=Color3.fromRGB(200,160,160),
},
Slider={
SliderBar=Color3.fromRGB(180,40,40),
SliderNumber=Color3.fromRGB(255,240,240),
},
Dropdown={Holder=Color3.fromRGB(40,10,10)}
},
Icons={
Error="rbxassetid://10709752996",
Button="rbxassetid://10709791437",
...
Colors={
Background=ColorSequence.new{
ColorSequenceKeypoint.new(0.00,Color3.fromRGB(5,20,25)),
ColorSequenceKeypoint.new(0.50,Color3.fromRGB(10,35,40)),
ColorSequenceKeypoint.new(1.00,Color3.fromRGB(5,20,25))
},
Primary=Color3.fromRGB(0,200,180),
OnPrimary=Color3.fromRGB(0,100,90),
ScrollBar=Color3.fromRGB(0,140,130),
Stroke=Color3.fromRGB(10,40,45),
Error=Color3.fromRGB(255,100,130),
Icons=Color3.fromRGB(220,250,245),
JoinButton=Color3.fromRGB(0,130,120),
Link=Color3.fromRGB(100,240,225),
Dialog={Background=Color3.fromRGB(8,28,32)},
Buttons={
Holding=Color3.fromRGB(0,180,165),
Default=Color3.fromRGB(15,45,50)
},
Border={
Holding=Color3.fromRGB(50,220,200),
Default=Color3.fromRGB(25,70,75),
},
Text={
Default=Color3.fromRGB(255,255,255),
Dark=Color3.fromRGB(190,220,215),
Darker=Color3.fromRGB(160,190,185),
},
Slider={
SliderBar=Color3.fromRGB(0,140,130),
SliderNumber=Color3.fromRGB(230,255,250),
},
Dropdown={Holder=Color3.fromRGB(10,35,40)}
},
Icons={
Error="rbxassetid://10709752996",
Button="rbxassetid://10709791437",
